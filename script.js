const AVAILABLE_WEEK_DAYS = ['星期日', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六'];
...
class CALENDAR {
    ...
    drawEvents() {
        ...
        let eventList = this.eventList[calendar.active.formatted] || ['这里没有你创建的计划！'];
        let eventTemplate = "";
    ...
    drawYearAndCurrentDay() {
        ...
        this.elements.currentWeekDay.innerHTML = `${calendar.active.year}年${calendar.active.month + 1}月${calendar.active.day}日 ${AVAILABLE_WEEK_DAYS[calendar.active.week]}`;
    }
